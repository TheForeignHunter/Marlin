...
#define STRING_CONFIG_H_AUTHOR "(Ben, Endy)" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 181.98
  #define DEFAULT_bedKi 28.79
  #define DEFAULT_bedKd 766.75
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37, -10, -1.75 }
